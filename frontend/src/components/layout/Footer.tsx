        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-foreground-muted mb-4 max-w-xs">
              관심사 기반 실시간 채팅으로 사람들과 연결되는 새로운 경험을 제공합니다.
            </p>
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="text-foreground-muted hover:text-foreground-primary transition-colors duration-200"
              ...
              <ul className="space-y-3">
                {footerLinks.product.map((link) => (
                  <li key={link.name}>
                    <a
                      href={link.href}
                      className="text-sm text-foreground-muted hover:text-foreground-primary transition-colors duration-200"
                    >
                      {link.name}
                    </a>
                  </li>
        ...
        <div className="mt-12 pt-8 border-t border-border-default">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-foreground-muted">
              © {currentYear} VibeChat. All rights reserved.
            </p>
